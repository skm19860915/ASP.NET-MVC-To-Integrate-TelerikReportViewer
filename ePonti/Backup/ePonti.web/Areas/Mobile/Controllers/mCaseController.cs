...
{
    [Authorize]
    public class mCaseController : ePonti.web.Controllers._baseMVCController
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            ViewBag.CaseComments = db.GetCaseCommentsByCaseID(id);

            //TODO: Proc not returning some data. So using below query. Need to merge into proc
        ...
        public ActionResult Edit(int? id, int? contactid, int? projectid)
        {
            ...
            ViewBag.Jobs = new SelectList(db.GetJobsByContactID_WithLockFalse(contactid), "ViewID", "Project", _case.ProjectID);
            ViewBag.CaseTypes = new SelectList(repo.GetCaseTypesBySiteCoID(siteusercompanyid), "CaseTypeID", "CaseType");
