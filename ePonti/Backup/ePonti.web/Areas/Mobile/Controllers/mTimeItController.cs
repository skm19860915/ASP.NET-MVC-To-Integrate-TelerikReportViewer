...
{
    public class mTimeItController : ePonti.web.Controllers._baseMVCController
    {
        ...
        public ActionResult Create(int? contactid, int? projectid)
        {
            ...
            ViewBag.PayTypes = new SelectList(projectData.Item2.Select(p => new { p.PayTypeID, p.Pay_Type }), "PayTypeID", "Pay_Type");
